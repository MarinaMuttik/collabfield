$(document).on('turbolinks:load', function() {
  ...
  $("body").on( "click", ".single-post-card, .single-post-list", function() {
    let posted_by = $(this).find('.post-content .posted-by').html();
    let post_heading = $(this).find('.post-content h3').html();
    let post_content = $(this).find('.post-content p').html();
    let interested = $(this).find('.post-content .interested').attr('href');
